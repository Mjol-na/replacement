...
static const int mk_arcade_gpio_maps[] = {17,  22,    15,  25,    23,    24,      12,  6, 26, 13, 16, 14, 5 };
// 2nd joystick on the b+ GPIOS                 up, down, left, right, start, select, a,  b,  tr, y,  x,  tl, hk
static const int mk_arcade_gpio_maps_bplus[] = {17,  22,    15,  25,    23,    24,      12,  6, 26, 13, 16, 14, 5 };

// Map joystick on the b+ GPIOS with TFT      up, down, left, right, start, select, a,  b,  tr, y,  x,  tl, hk
static const int mk_arcade_gpio_maps_tft[] = {17,  22,    15,  25,    23,    24,      12,  6, 26, 13, 16, 14, 5 };
